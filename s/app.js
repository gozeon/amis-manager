...
app.use(utils.routerFormat('/project'), projectRouter)
app.use(utils.routerFormat('/page'), pageRouter)
app.use(utils.routerFormat('/group'), groupRouter)
...
app.use(function (err, req, res, next) {
    ...
    res.json(Object.assign(err.output.payload, { data: err.data || [] }))
})
